...
// const actionsSliders = document.querySelectorAll('.swiper-container');

// sliders.forEach((el) => {
// 	let actionsSlidwers = new Swiper(el, {
// 		slidesPerView: 2,
// 		spaceBetween: 10,
// 		loop: true,
// 		pagination: {
...
let swiper = new Swiper('.sliderbox', {
  loop: true,
  effect: 'fade',
  autoHight: true,
...
let carousel = new Swiper('.carouselbox', {
  spaceBetween: 30,
  slidesPerView: 2,
  centeredSlides: true,
  // If we need pagination
...
let thumbImage = new Swiper('.thumbnail-image', {
  // loop: true,
  direction: 'vertical',
  spaceBetween: 15,
  slidesPerView: 10,
...
let mainImage = new Swiper('.main-image', {
  loop: true,
  autoHeight: true,
  pagination: {
    el: '.swiper-pagination',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  $triggerOpen: document.querySelectorAll('[trigger-button]'),
  $triggerClose: document.querySelectorAll('[close-button]'),
  $overlay: document.querySelector('[data-overlay]'),
  $submenu: document.querySelectorAll('.child-trigger')
});
...
/* harmony import */ var _vendor_swiper_bundle_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/swiper-bundle.min.js */ "./src/js/vendor/swiper-bundle.min.js");
/* harmony import */ var _vendor_swiper_bundle_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_swiper_bundle_min_js__WEBPACK_IMPORTED_MODULE_1__);
...
for (let i = 0; i < _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$triggerOpen.length; i++) {
  let currentId = _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$triggerOpen[i].dataset.target,
    targetEl = document.querySelector(`#${currentId}`);
  console.log(currentId);
  const openData = function () {
    targetEl.classList.remove('active');
    _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$overlay.classList.remove('active');
  };
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$triggerOpen[i].addEventListener('click', function () {
    targetEl.classList.add('active');
    _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$overlay.classList.add('active');
  });
  targetEl.querySelector('[close-button]').addEventListener('click', openData);
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$overlay.addEventListener('click', openData);
}
...
// mobile menu
_vars__WEBPACK_IMPORTED_MODULE_0__["default"].$submenu.forEach(menu => menu.addEventListener('click', function (e) {
  e.preventDefault();
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$submenu.forEach(item => item != item ? item.closest('.has-child').classList.remove('active') : null);
  if (this.closest('.has-child').classList != 'active') {
    this.closest('.has-child').classList.toggle('active');
  }
}));

// console.log(vars.$submenu)
...
//   document.querySelector('.header-main__bottom').classList.toggle('visually-hidden');
//   document.querySelector('.breadcrumbs').classList.toggle('visually-hidden');
//   document.querySelector('.header-main-nav-line').classList.toggle('visually-hidden');
//   document.querySelector('.header-main__right').classList.toggle('visually-hidden');
...
// // let el = document.querySelectorAll('.menu-nav__nav-link')
...
// //     id = this.dataset.text
// //     const f = document.querySelector(`[data-id="${id}"]`)

// //     f.classList.toggle('header-menu__box--active')
// //     // f.nextElementSibling.remove('header-menu__box--active')
...
// //       id = this.dataset.text
// //       const f = document.querySelector(`[data-id="${id}"]`)
// //       f.parentElement.remove('header-menu__box--active')
// //       f.nextElementSibling.remove('header-menu__box--active')
// //     } else {
// //        return false;
// //     }
...
/* harmony import */ var _components_search_toggle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/search-toggle */ "./src/js/components/search-toggle.js");
/* harmony import */ var _components_toggle_menu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/toggle-menu */ "./src/js/components/toggle-menu.js");
